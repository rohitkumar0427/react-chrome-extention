...
//       <br/>
//       <div class='_2'>STUDYING IS MORE IMPORTANT THAN  ${pageName}</div>
//   </div>
//    `;
// };

// export function WebsiteBlocker(pageName) {
//   let blWebs;

//   let webs = ["www.facebook.com", "www.netflix.com"];
//   if (!GetData("blocked")) SetData("blocked", webs);

//   blWebs = GetData("blocked");
